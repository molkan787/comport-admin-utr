...
import { LZSSService } from '../../services/tools/lzss'
...
export default {
    ...
    methods: {
        ...
        async compressFileClick(){
            ...
            this.aip = 'compress'
            try {
                await LZSSService.CompressFile(this.inFile, this.outFile)
        ...
        async decompressFileClick(){
            ...
            this.aip = 'decompress'
            try {
                await LZSSService.DecompressFile(this.inFile, this.outFile)
