...
import { LZRBService } from '../../services/tools/lzrb'
...
export default {
    ...
    methods: {
        ...
        async compressFileClick(){
            ...
            this.aip = 'compress'
            try {
                await LZRBService.CompressFile(this.inFile, this.outFile)
        ...
        async decompressFileClick(){
            ...
            this.aip = 'decompress'
            try {
                await LZRBService.DecompressFile(this.inFile, this.outFile)
